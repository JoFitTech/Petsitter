...
public record OfferCardDto(
    ...
    public OfferCardDto(
        ...
        this(id, title, startDate, endDate, price, animalType, creatorVerified, description,
                frequency, recurringWeekdays, timeSlot, careType, petName, petSpecies, petBreed, petTags, pets,
                postalCode, city, distanceKm, favorited, offerType, creatorUserId, creatorDisplayName, coverTiles,
                creatorProfileImage, null, null);
    }
