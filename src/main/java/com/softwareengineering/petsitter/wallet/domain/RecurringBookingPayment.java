...
@Entity
@Table(
        name = "recurring_booking_payment",
        uniqueConstraints = @UniqueConstraint(
                name = "uk_recurring_booking_payment_period",
                columnNames = {"booking_id", "period_start"}))
public class RecurringBookingPayment {
    ...
    @Column(name = "price_per_occurrence", nullable = false, precision = 12, scale = 2)
    ...
    public BigDecimal getPricePerOccurrence() {
        return pricePerOccurrence;
    }

    public void setPricePerOccurrence(BigDecimal pricePerOccurrence) {
        this.pricePerOccurrence = pricePerOccurrence;
    }
